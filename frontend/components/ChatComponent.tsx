  ...
  return (
    <div className="w-full">
      <motion.div
        ...
        className={`${
          darkMode ? "bg-chat-text-field-background-dark" : "bg-white/80"
        } p-4 rounded-3xl`}
      >
        <div>
          <textarea
            ...
            className={`${
              darkMode && "text-white"
            } w-full h-auto p-4 rounded-2xl bg-inherit outline-none placeholder-gray-500 resize-none font-sans`}
            rows={1}
          />
        </div>
            ...
            <button
              ...
              className={`w-full p-2 rounded-full cursor-pointer bg-primary text-white hover:bg-primary/80 hover:text-white/80 ${
                darkMode
                  ...
                  : "disabled:bg-black/10 disabled:text-black/40 disabled:hover:bg-black/10 disabled:hover:text-black/40"
              }`}
